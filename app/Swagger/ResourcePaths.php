...
class ResourcePaths
{
     ...
     * @OA\Get(path="/api/members/reports", tags={"Members"}, summary="Get filtered members for reports", security={{"bearerAuth": {}}}, @OA\Response(response=200, description="Filtered members", @OA\JsonContent(type="object")))
     * @OA\Get(path="/api/member-marriages", tags={"Members"}, summary="List linked member marriages", security={{"bearerAuth": {}}}, @OA\Response(response=200, description="Member marriages", @OA\JsonContent(type="object")))
     *
     * @OA\Post(path="/api/member-marriages", tags={"Members"}, summary="Link a husband and wife", security={{"bearerAuth": {}}}, @OA\RequestBody(required=true, @OA\JsonContent(ref="#/components/schemas/GenericJsonRequest")), @OA\Response(response=201, description="Marriage linked", @OA\JsonContent(type="object")))
     *
     * @OA\Delete(path="/api/member-marriages/{id}", tags={"Members"}, summary="Remove a member marriage link", security={{"bearerAuth": {}}}, @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")), @OA\Response(response=200, description="Marriage link removed", @OA\JsonContent(type="object")))
     *
     ...
     *
     * @OA\Get(path="/api/guests/stats", tags={"People"}, summary="Get guest statistics", security={{"bearerAuth": {}}}, @OA\Response(response=200, description="Guest statistics", @OA\JsonContent(type="object")))
